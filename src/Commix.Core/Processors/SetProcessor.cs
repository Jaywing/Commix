...
namespace Commix.Core.Processors
{
    /// <summary>
...
namespace Commix.Core.Schema
{
    public static class SetStageProcessorExtensions
    {
        ...
        {
            return builder
                .Add(Processor.Use<Commix.Core.Processors.SetProcessor>(configure));
        }
    }
    ...
    public static class GetProcessorExtensions
    {
        ...
        {
            return builder
                .Add(Processor.Use<Commix.Core.Processors.GetProcessor>(configure));
        }
        ...
        {
            return builder
                .Add(Processor.Use<Commix.Core.Processors.GetProcessor>(c =>
                {
                    c.Option(Commix.Core.Processors.GetProcessor.SourcePropertyOptionKey, sourceProperty);
                    configure?.Invoke(c);
                }));
        }
    }
