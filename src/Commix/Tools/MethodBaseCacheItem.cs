...
namespace Commix.Tools
{
    ...
    internal struct MethodBaseCacheItem : IEquatable<MethodBaseCacheItem>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is MethodBaseCacheItem item && Equals(item);
        }
        ...
        {
            return string.Equals(MethodBase, other.MethodBase) && Equals(Type, other.Type);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return ((MethodBase?.GetHashCode() ?? 0) * 397) ^ (Type?.GetHashCode() ?? 0);
            }
        }
    }
}